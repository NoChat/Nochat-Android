...
/*    private void findViewByIdInit(){
    ...
    private void AsyncHttpClient(RequestParams paramData) {
        ...
        Log.i(CTAG, "#서버와 통신 준비중#" + "JSONDATA:" + param);
